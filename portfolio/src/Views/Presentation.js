    ...
    return (
        ...
        >
            <Slide triggerOnce>
                ...
                >
                    <h1 className="font-bold text-3xl md:text-5xl lg:text-6xl text-center w-full bg-color-primary-2 text-white p-3 md:p-5 lg:p-8"> PRESENTATION </h1>
                    <div>
                        <img className="rounded-full h-32 w-32 md:h-48 md:w-48 lg:h-64 lg:w-64" src={require("../Assets/photo.jpg")} alt="Profil"/>
                    </div>
                    <div className="pl-3 md:text-2xl lg:text-3xl md:pl-5">
                        <p>
                    ...
                    <div className="flex flex-col space-y-5 w-4/5 md:w-3/5 md:text-center">
                        <Link
                            className="bg-color-primary-2 cursor-pointer text-white font-bold py-2 px-5 rounded text-xl md:text-3xl lg:text-4xl "
                            activeClass="active"
                            to="contact"
                            spy={true}
                            smooth={true}
